...
if __name__ == "__main__":
    print("1. Example:", part_1("data/day04-example.txt"), "=? 18")
    print("1. Answer:", part_1("data/day04-data.txt"))
    print("2. Example:", part_2("data/day04-example.txt"), "=? 9")
    print("2. Answer:", part_2("data/day04-data.txt"))
