...
def fn_1(grid, start, end):
    ...
    return [closed_set[end[0], end[1], dx, dy] for dx, dy in [(1, 0), (0, 1), (-1, 0), (0, -1)] if
            (end[0], end[1], dx, dy) in closed_set]
        ...
        for ndx, ndy in [(0, 1), (1, 0), (0, -1), (-1, 0)]:
            ...
            if (nx, ny, ndx, ndy) in closed_set:
                ...
                if closed_set[(nx, ny, ndx, ndy)][0] == closed_set[(x, y, dx, dy)][0] + cost:
                    ...
                    closed_set[(nx, ny, ndx, ndy)] = (closed_set[(x, y, dx, dy)][0] + cost, [(x, y, dx, dy)])
            else:
                closed_set[(nx, ny, ndx, ndy)] = (closed_set[(x, y, dx, dy)][0] + cost, [(x, y, dx, dy)])
            open_set.add((nx, ny, ndx, ndy))

    x, y = end
    end_points = {(x, y, dx, dy): closed_set[x, y, dx, dy] for dx, dy in [(1, 0), (0, 1), (-1, 0), (0, -1)] if
                  (x, y, dx, dy) in closed_set}
...
if __name__ == "__main__":
    print("1. Example:", part_1("data/day16-example1.txt"), "=? 7036")
    print("1. Example:", part_1("data/day16-example2.txt"), "=? 11048")
    print("1. Answer:", part_1("data/day16-data.txt"))
    print("2. Example:", part_2("data/day16-example1.txt"), "=? 45")
    print("2. Example:", part_2("data/day16-example2.txt"), "=? 64")
    print("2. Answer:", part_2("data/day16-data.txt"))
