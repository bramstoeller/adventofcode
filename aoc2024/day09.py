...
if __name__ == "__main__":
    ...
    run(part_1, "data/day09-example.txt", expected=1928)
    run(part_1, "data/day09-data.txt", expected=6384282079460)
    run(part_2, "data/day09-example.txt", expected=2858)
    run(part_2, "data/day09-data.txt", expected=6408966547049)
